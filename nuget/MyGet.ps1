...
# update sourceMappingURL in draggable-mcs.min.js
(Get-Content $env:SourcesPath\dist\js\draggable-mcs.min.js).replace("sourceMappingURL=", "sourceMappingURL=Scripts/") | Set-Content $env:SourcesPath\dist\js\draggable-mcs.min.js

# create packages
& $nuget pack "$env:SourcesPath\nuget\draggable-mcs.nuspec" -Verbosity detailed -NonInteractive -NoPackageAnalysis -BasePath $env:SourcesPath -Version $bsversion